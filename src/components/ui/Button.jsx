  ...
  return (
    <button
      className={cn(
        ...
        {
          'bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:from-indigo-700 hover:to-purple-700 shadow-xl hover:shadow-2xl hover:scale-105': variant === 'default' || variant === 'primary',
