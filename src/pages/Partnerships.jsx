import { ArrowRight, Coins, Files, Gauge, HeartHandshake, LineChart, Sparkles, Workflow, Trophy } from 'lucide-react'
...
const guardrails = [
  { title: 'Speed to value', detail: 'First call to live pod in under 10 days; SLAs visible to partners.', icon: Gauge },
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-r from-slate-900 via-white/5 to-slate-900 p-10 shadow-2xl shadow-slate-900/40">
          <div className="flex items-center justify-between gap-6 flex-wrap">
            ...
            <a
              href="mailto:partners@finanshels.com?subject=Referral%20program%20application"
